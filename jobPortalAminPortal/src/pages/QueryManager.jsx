  ...
  return (
    <div style={{ padding: "8px 0" }}>
      ...
      <div style={{ marginBottom: isMobile ? 16 : 24 }}>
        <Space>
          <DatabaseOutlined
            style={{ fontSize: isMobile ? 18 : 22, color: "#1677FF" }}
          />
      ...
      >
        ...
        >
          <Text
            strong
            style={{ fontSize: isMobile ? 12 : 14, whiteSpace: "nowrap" }}
          >
            Quick Templates:
          </Text>
          <Select
      ...
      >
        ...
        >
          ...
          {/* Column dropdown */}
          <div
            style={{ flex: 2, width: isMobile ? "100%" : "auto", minWidth: 0 }}
          >
            <div
              style={{
                display: "flex",
        ...
        {selectedTable && (
          <Text
            type="secondary"
            style={{ fontSize: 11.5, display: "block", marginTop: 8 }}
          >
            Query auto-filled above. Leave columns empty to select all (
            <code>*</code>). You can still edit the query freely before running.
          </Text>
        )}
